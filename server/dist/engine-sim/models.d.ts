/**
 * Wire models for the Engine Sim feature.
 *
 ...
 *
 * Kept under `engine-sim/` so the existing `/api/config` flow (different
 * domain, different shape) is not touched.
 */
export declare type Side = 'left' | 'right';
export declare type Wheel = '1' | '2' | '3' | '4';
export declare type EntityId = Side;
