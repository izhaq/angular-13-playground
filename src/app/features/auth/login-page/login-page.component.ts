 ...
 * (set by the guard in slice 2) or the host-configured default post-login
 * route (see AUTH_ROUTES_CONFIG / auth-urls.ts). Error UX beyond a single
 * generic message arrives in slice 4.
 */
@Component({
