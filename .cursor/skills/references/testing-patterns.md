...
describe('TaskFormComponent', () => {
  ...
  it('submits form with entered data', () => {
    ...
    titleInput.nativeElement.value = 'New Task';
    ...
    expect(taskService.createTask).toHaveBeenCalledWith(
      jasmine.objectContaining({ title: 'New Task' })
    );
  });
...
expect(taskService.createTask).toHaveBeenCalledWith(jasmine.objectContaining({ title: 'Test' }));
